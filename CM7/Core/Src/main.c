...
// Current subdivision.
volatile uint32_t divisionCount = 0;
...
// WARNING UART1 is connected to st-link
...
//	  printf("TIM2->CCR2 %lu TIM2->CNT %lu %lu %lu\n", TIM2->CCR2, TIM2->CNT, divisionPeriod, divisionCount);
//	  HAL_Delay(1000);
...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(DIV_OUT_GPIO_Port, DIV_OUT_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pin : DIV_OUT_Pin */
  GPIO_InitStruct.Pin = DIV_OUT_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
  HAL_GPIO_Init(DIV_OUT_GPIO_Port, &GPIO_InitStruct);
